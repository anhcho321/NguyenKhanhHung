...
namespace WindowsFormsApp16
{
    public partial class FrmMain : Form
    {
        ...
        SqlCommand commmand;
        string str = @"Data Source=localhost\SQLEXPRESS;Initial Catalog=ListHinh;Integrated Security=True";
        ...
        void loaddata()
        {
            ...
            commmand.CommandText = "select * from Hinh ";
        ...
        public FrmMain()
        {
            ...
            buttons = new List<Button> { btnCircle, btnEllipse, btnLine, btnPolygon, btnRectangle, btnSelect, btnSquare };
                ...
                if (currentShape != CurrentShape.NoDrawing)
                {
                    if (shape is Curve)
                    {
                        ...
                        if (currentShape == CurrentShape.Curve && !isDrawCurve)
                        {
                            ...
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.Name));
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.Begin.X.ToString() + ";" + shape.Begin.Y.ToString()));
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.End.X.ToString() + ";" + shape.End.Y.ToString()));
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.Color.ToString()));
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.DashStyle.ToString()));
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.LineWidth.ToString()));
                            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, shape.IsSelected.ToString()));
                        ...
                        else if (currentShape == CurrentShape.Bezier && !isDrawBezier)
                        {
                            ...
                            this.listView1.Items.Add(eVent);
                             commmand = connection.CreateCommand();
            commmand.CommandText = "insert into Hinh values('" + btnGroup.Text + "','" + btnGroup.Text + "','" + btnGroup.Text + "','" + btnGroup.Text + "','" + btnGroup.Text + "','" + btnGroup.Text + "','" + btnGroup.Text + "','" + btnGroup.Text + "')";
        ...
        public void GETVALUE(string value)
        {
            ...
            lb.Text = value;
            lb.AutoSize = true;
            psfMain.Controls.Add(lb);
            ControlExtension.Draggable(lb, true);
            
            ListViewItem eVent = new ListViewItem(this.ID.ToString());
            ID++;
            eVent.SubItems.Add(new ListViewItem.ListViewSubItem(eVent, lb.Text));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            Form2 frm = new Form2();
            frm.mydata = new Form2.GETDATA(GETVALUE);
            frm.ShowDialog();
        ...
        private int h()
        {
            ...
            int h = radom.Next(minValue: 1000, maxValue: 100000);
            return h;
        }
            private void bntSave_Click(object sender, EventArgs e)
        {
            DialogResult k = MessageBox.Show
               ("Bạn có chắc muốn xuất file không?", "Error", MessageBoxButtons.OKCancel);
            if (k == DialogResult.OK)
                using (var bmp = new Bitmap(psfMain.Width, psfMain.Height))
                {
                    psfMain.DrawToBitmap(bmp, new System.Drawing.Rectangle(0, 0, bmp.Width, bmp.Height));
                    bmp.Save(@"im/" + h() + ".bmp");
                }
        }
        ...
        private void bntOpen_Click(object sender, EventArgs e)
        {
            ...
            {
                psfMain.BackgroundImage = new Bitmap(open.FileName);
            }
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            commmand = connection.CreateCommand();
            commmand.CommandText = "delete from Hinh where ID= '" + listView1.SelectedItems[0].Text + "'";
            commmand.ExecuteNonQuery();
            loaddata();

            commmand.CommandText = "insert into Hinh values('" + listView1.SelectedItems[0].SubItems[0].Text + "','" + listView1.SelectedItems[0].SubItems[1].Text + "','" + listView1.SelectedItems[0].SubItems[2].Text + "','" + listView1.SelectedItems[0].SubItems[3].Text + "','" + "Black" + "','" + listView1.SelectedItems[0].SubItems[5].Text + "','" + listView1.SelectedItems[0].SubItems[6].Text + "','" + listView1.SelectedItems[0].SubItems[7].Text + "')";
            commmand.ExecuteNonQuery();
            loaddata();
        }
        ...
        {
            commmand = connection.CreateCommand();
            commmand.CommandText = "delete from Hinh where ID= '" + txtID.Text + "'";
            commmand.ExecuteNonQuery();
            loaddata();
        }
